...
export const UnitConverter: React.FC = () => {
  ...
  const convertedValue = convertUnits(inputValue, fromUnit, toUnit, concentrationMgMl);
  ...
  return (
    <div className="flex flex-col gap-6 max-w-3xl mx-auto pb-10">
      <div className="bg-gradient-to-r from-amber-900/40 via-orange-900/30 to-slate-900/60 p-6 rounded-2xl border border-amber-500/20 backdrop-blur-md">
        ...
        <div className="bg-slate-900/80 p-4 rounded-xl border border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              onChange={(e) => setConcentrationMgMl(parseFloat(e.target.value) || 0.1)}
